...
⚠️ **두 빌드의 차이는 버전 값뿐이다.** 코드 차이 없음. target 은 커밋 **`47a63b9`** 그대로, baseline 은 **같은 커밋에서 상수만 낮춰** 빌드하고 **커밋하지 않았다**(트리는 되돌렸다).
...
| `GNLink-0.2.15.apk` | 11,518,126 | `9748a54e…ed99` |
| `GNLinkSetup-0.2.108.exe` | 4,339,712 | `def1e344…465c` |
| `GNLink-0.2.16.apk` | 11,518,126 | `c4077363…2d4f` |
manifest·서명은 `.claude/rel/0.2.108/`(미추적): `windows.manifest` 1,533B `b65e2198…5907` · `android.manifest` 326B `78737f8b…e13d` · 각 `.sig` 128자.
