...
- 검증:
  - [ ] AMD/NVIDIA/Intel별 backend 고정 표기 + fallback 동작 실측 검증 (2026-03-07 재검증: `mft_hw` 반복 5회 `OVERALL_OK`, `amf_hw` 1회 `OVERALL_OK`, `nvenc_hw/qsv_hw`는 `backend unavailable`로 host init fail)
