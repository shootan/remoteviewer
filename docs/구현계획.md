...
- 검증:
  - [ ] AMD/NVIDIA/Intel별 backend 고정 표기 + fallback 동작 실측 검증 (2026-03-07 1차 자동검증 및 콘솔 세션 재검증 동일: `mft_hw`만 통과, `nvenc_hw/qsv_hw`는 `backend unavailable`로 host init fail)
