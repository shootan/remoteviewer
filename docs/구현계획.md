...
- 검증 전용(추가 코드 작업 없음):
  ...
  - [x] 외부 2PC 테스트 준비물 정리 (최신 external bundle + quickstart + `m9_easy`/WAN capture 스크립트 포함, 기본 smoke profile은 fixed 30fps, native window-input template/web GUI path 분리)
