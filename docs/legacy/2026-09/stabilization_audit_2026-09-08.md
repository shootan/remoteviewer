...
- [x] A02/A06 입력 provenance 일원화·실패 경계 검증 (history #418, 회귀 [4])
- [~] A03/A04/A05 NACK/hold/복구 episode 통합 설계·유계 회귀 — A04(무후속 소진 폴백, Codex 확정 규칙) 완료 (history #417); A03·A05 미착수
