...
// Input:   ctx.frameBuf.frame, picker visibility, PresentStats trace switches.
...
//
// The one place allowed to set ctx.frameBuf.paintQueued. It was open-coded in four places, so a fix
