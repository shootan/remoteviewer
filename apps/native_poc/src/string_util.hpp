...
// Small ASCII / UTF-8 / HRESULT string helpers shared by the host and the viewer.
//
...
// Callers: host_* modules (through host_string_util.hpp), viewer_env_util.hpp.
//
// This is the host split Phase 0 host_string_util.hpp, unchanged; the viewer carried byte-identical
// copies of trim_ascii / ascii_lower / utf8_to_wide, so viewer split Phase 0-15 made the file shared
// and left host_string_util.hpp as a forwarding include. Behavior is byte-identical.
