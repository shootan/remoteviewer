...
$matrix = @(
  @{ tag = "1080p-static"; scene = "static"; width = 1920; height = 1080; bitrate = 8000000; keyint = 30 },
  @{ tag = "1080p-scroll"; scene = "scroll"; width = 1920; height = 1080; bitrate = 8000000; keyint = 30 },
  @{ tag = "1080p-video";  scene = "video";  width = 1920; height = 1080; bitrate = 8000000; keyint = 30 },
  @{ tag = "720p-scroll";  scene = "scroll"; width = 1280; height = 720;  bitrate = 5000000; keyint = 60 }
)
if ($Only.Count -gt 0) {
  ...
  for ($i = 1; $i -le $Repeats; $i++) {
    ...
    if ($entry.scene -ne "static") {
      $sceneProc = Start-Process -FilePath "powershell.exe" -ArgumentList @(
        ...
        "-Scene", $entry.scene, "-Seconds", ($HostSeconds + 20)
